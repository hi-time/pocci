...
module.exports = {
  addDefaults: function(options) {
    ...
    options.redmine.smtpDomain  = options.redmine.smtpDomain  || smtp.getDomain(options);
    options.redmine.smtpHost    = options.redmine.smtpHost    || smtp.getHost(options);
    options.redmine.smtpPort    = options.redmine.smtpPort    || smtp.getPort(options);
